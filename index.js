const projects = [
  // ── TOP 6 (visible by default) ──────────────────────────────────────────
  {
    ...
    img: '/images/tcs_simplifier_og.webp',
    thumbIcon: 'summarize',
  },
  {
  ...
  },
  {
    ...
    badge: 'DIGITAL AI',
    color: 'green',
    icons: ['robot_2', 'description'],
    href: 'https://johnb.io/llms-generator',
  ...
  },
  {
    ...
    desc: 'Paste any AI prompt and get a stronger version with a short change log. Includes a starter library for common tasks. Works with ChatGPT, Claude, Gemini and any LLM.',
    category: 'digital',
    badge: 'DIGITAL AI',
    color: 'green',
    icons: ['tips_and_updates', 'auto_fix_high'],
    href: 'https://johnb.io/prompt-improver',
    img: '/images/prompt_improver_og.webp',
    thumbIcon: 'tips_and_updates',
  },
  {
    id: 'faq-schema',
    title: 'FAQ Schema Generator',
    desc: 'Turn question and answer pairs into valid FAQPage JSON-LD structured data. Manual builder plus AI draft mode. Ready to paste into your page head.',
    category: 'digital',
    badge: 'DIGITAL AI',
    color: 'green',
    icons: ['data_object', 'quiz'],
    href: 'https://johnb.io/faq-schema',
